      ...
      <div className="footer-content">
        ...
        <div className="content1">
          ...
          <p>
            ...
            build a picture of the city for new visitor. Hope these resources
            can help their experience of discover and explore the city more
            enjoyable.
          </p>
        </div>
      </div>
      <p className="credit">
        This project was coded by Ni Duong and is
        <a
          href="https://github.com/duongni/my-hometown"
          target="_blank"
          rel="noreferrer"
          title="Link to Sourced Code"
        >
          {" "}
          open sourced.
        </a>
